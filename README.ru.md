...
## Google Colab:
  1) [Код визуализации игры](https://colab.research.google.com/drive/1Zs_JpAHJzPyYjarq5cz_5qTQ91pnbAGl#scrollTo=f7jhFGIpt1uf)
  2) [Код для постоения графиков](https://colab.research.google.com/drive/10QMhwJ8rYr7qJr205R7IX4qAdHXD9g4E?usp=sharing)
  3) [Ядро DQN](https://colab.research.google.com/drive/1fNQChQLkYN1QIvSSMlRks-M7TPi1uelM?usp=sharing)
...
1. Мы смогли обучить агента проходить достаточно далеко по уровню, что несомненно является успешным выполнением проекта 
2. Каждый из нас получил бесценный опыт работы в команде
3. Мы получили опорные знания и базовое представление о мире Machine Learning, на основе этих знаний мы планируем работать над похожими проектами 


### Лучшая игра агента в Марио:

![Лучшая игра агента в Марио](./assets/videos/best_gameplay_mario.gif)
...
![Видео игры нетренированного агента в Cartpol](./assets/videos/cartpol_untrained.gif)

Финальная стадия тренировки агента:

![Видео игры тренированного агента в Cartpol](./assets/videos/cartpol_trained.gif)
...
![Видео игры нетренированного агента в Lunar Lander](./assets/videos/lander_untrained.gif)

Финальная стадия тренировки агента:

![Видео игры тренированного агента в Lunar Lander](./assets/videos/lander_trained.gif)
